...
export class RetireToucanSpecificCall extends ethereum.Call {
  get inputs(): RetireToucanSpecificCall__Inputs {
    return new RetireToucanSpecificCall__Inputs(this);
  }

  get outputs(): RetireToucanSpecificCall__Outputs {
    return new RetireToucanSpecificCall__Outputs(this);
  }
}

export class RetireToucanSpecificCall__Inputs {
  _call: RetireToucanSpecificCall;

  constructor(call: RetireToucanSpecificCall) {
    this._call = call;
  }
...
export class RetireToucanSpecificCall__Outputs {
  _call: RetireToucanSpecificCall;
